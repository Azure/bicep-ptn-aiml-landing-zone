...
output containerAppsEndpoints array = [
  for app in containerAppsList: { 
    name: '${app.canonical_name}_ENDPOINT', value: 'https://${app.fqdn}', label: 'ai-lz', contentType: 'text/plain' 
  }
]
...
output containerAppsName array = [
  for app in containerAppsList: { 
    name: '${app.canonical_name}_NAME', value: app.name, label: 'ai-lz', contentType: 'text/plain' 
  }
]
